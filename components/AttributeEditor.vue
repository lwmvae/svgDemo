  ...
  export default {
    ...
    computed:{ 
      ...
      ...mapState({
        ...
        height:state=>state.attributes.cacheHeight,
        width: state=>state.attributes.cacheWidth,
        ...
        heightVisble:state=>state.show.cacheHeight,
        widthVisble: state=>state.show.cacheWidth,
